...
const Contact = () => {
  ...
  const contactLinks = contactInfo ? [
    ...
    contactInfo.linkedin && { icon: <Linkedin size={20} />, label: 'LinkedIn', value: '/in/sharathchelimella', href: contactInfo.linkedin },
    contactInfo.github && { icon: <Github size={20} />, label: 'GitHub', value: '/sharathchelimella', href: contactInfo.github },
